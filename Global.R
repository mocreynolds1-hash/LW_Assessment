...
lw_points <- st_read("/Users/milliereynolds/Documents/Masters/GIS/Practicals/cleaned_lw_shapefile.shp")
river <- st_read("/Users/milliereynolds/Documents/Masters/GIS/Practicals/Part A/RiverTorridge.shp")
bridges <- st_read("/Users/milliereynolds/Documents/Masters/GIS/Practicals/relevant bridges.shp")
bridges <- bridges[!st_is_empty(bridges$geometry), ]
bridges_snapped2 <- read.csv("/Users/milliereynolds/Bridges_snapped2")
...
# Add Wood catchers
wood_catchers <- st_read("/Users/milliereynolds/Documents/Masters/GIS/Practicals/wood_catcher_R2.shp")
...
# Perform clustering
clusters2 <- st_read("/Users/milliereynolds/Documents/Masters/GIS/Practicals/Clusters for Practical 6.shp")
...
heatmap <- rast("/Users/milliereynolds/Documents/Masters/GIS/Practicals/Heatmap.tif")
...
aspect1 <- rast("/Users/milliereynolds/aspect.tif")
